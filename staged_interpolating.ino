...
void loop() {
  ...
  injector1_opening_time = pgm_read_word(&injector1_map[index]) + fraction * (pgm_read_word(&injector1_map[index + 1]) - pgm_read_word(&injector1_map[index])) + correction;
  injector2_opening_time = pgm_read_word(&injector2_map[index]) + fraction * (pgm_read_word(&injector2_map[index + 1]) - pgm_read_word(&injector2_map[index])) + correction;
